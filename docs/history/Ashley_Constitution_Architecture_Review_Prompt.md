# Ashley Constitution — Historical Architecture-Review Prompt

> **HISTORICAL / SUPERSEDED FORM.** This file preserves the architecture-review
> prompt that previously occupied `docs/Ashley_Constitution.md`. It is
> provenance for how the Constitution was drafted and reviewed. It is **not**
> the Constitution. It is **not** current architecture. It is **not** an
> executable review contract.
>
> Current constitutional authority:
> [`../Ashley_Constitution.md`](../Ashley_Constitution.md).
>
> Relocated 2026-08-27 during documentation-authority reconciliation. The
> substantive constitutional meaning was preserved in the current file; review
> scaffolding ("Your Role", investigation questions, staged deliverables)
> remains here.
