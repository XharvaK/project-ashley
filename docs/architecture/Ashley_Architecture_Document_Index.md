...
| External Effect and Authority Architecture | [`docs/architecture/External_Effect_and_Authority_Architecture.md`](External_Effect_and_Authority_Architecture.md) | Cross-cutting observation, credential, representation, commit, receipt, witness, and reconciliation contracts | 2026-08-21 | `AUTHORITATIVE` | Parent of connectors, procedures, Computer Use, Sandbox M7 engineering effects, and Discord communication. Computer Use is one consumer, not the parent of generic external action. |
| Authority Kernel Architecture | [`docs/architecture/Ashley_Authority_Kernel_Architecture.md`](Ashley_Authority_Kernel_Architecture.md) | Runtime evaluator of External Effect law; domain policies; Communication Policy as first consumer | 2026-08-23 | `AUTHORITATIVE` | Instantiates External Effect. Not a second Agency. Not a Speech Authorization System. Grants no implementation. |
| Authority Kernel Implementation Planning | [`docs/architecture/Ashley_Authority_Kernel_Implementation_Planning.md`](Ashley_Authority_Kernel_Implementation_Planning.md) | Seam inventory and planning questions for a later implementation plan | 2026-08-23 | `SUPPORTING` | Planning foundation only. Does not authorize code, schema, or M5. |
