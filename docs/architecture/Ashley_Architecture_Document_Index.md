...
| Ashley Constitution | [`docs/Ashley_Constitution.md`](../Ashley_Constitution.md) | Long-form behavioral and architectural constitution | Current; `## Model` amended 2026-08-25 | `AUTHORITATIVE` | Preserves stable principles and intentionally evolvable implementation. `## Model` now governs multi-provider Model Fabric; it does not activate routes. |
