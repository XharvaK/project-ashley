...
| Model Fabric roadmap handoff | [`docs/handoffs/MODEL_FABRIC_ROADMAP_HANDOFF.md`](../handoffs/MODEL_FABRIC_ROADMAP_HANDOFF.md) | MF-M1 implementation and acceptance handoff | 2026-08-25 | `SUPPORTING` | Local candidate `d918572c` from exact `5a05e96e`; acceptance and production promotion remain separate. Not architecture. |
...
| Roadmap §5.6 Sandbox `CURRENT WORK` vs §3 Model Fabric as owner-selected current delivery | Phase-contract register vs live delivery sentence. | Treat §3 + Model Fabric docs as live delivery. MF-M1 local candidate is `d918572c`; acceptance and promotion remain separate. §5.6 is not a dashboard. |
