/**
 * Sandbox V2 typed-capability vocabulary (Sandbox V2 M2).
 *
 ...
 *
 * Model/cognition boundary: inspection results are observation evidence for
...
export type SandboxV2CapabilitySpec = {
  operation: SandboxV2OperationName;
  family: "sandbox_workspace_file_roundtrip" | "project_inspection";
