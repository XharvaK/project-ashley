...
/**
 * Structural copy ceilings. This is the shared sanitized-tree contract; the
 * broker's `DisposableWorkspaceLimits` (which adds `ttlMs`) satisfies it.
 */
export type TreeCopyLimits = {
